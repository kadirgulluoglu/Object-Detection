...
class MoneyDetection extends StatefulWidget {
  const MoneyDetection({Key? key}) : super(key: key);

  @override
  State<MoneyDetection> createState() => _MoneyDetectionState();
}

class _MoneyDetectionState extends State<MoneyDetection> {
  ...
  loadModel() async {
    await Tflite.loadModel(
        model: "assets/money_detection.tflite",
